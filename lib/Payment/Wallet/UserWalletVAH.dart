...
class VAHWalletScreen extends StatefulWidget {
  Map userMap;
  User user;

  VAHWalletScreen({Key? key,required this.userMap,required this.user}) : super(key: key);

  @override
  State<VAHWalletScreen> createState() => _VAHWalletScreenState();
}

class _VAHWalletScreenState extends State<VAHWalletScreen> {
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await FirebaseFirestore.instance
                  ...
                  "VetName": widget.userMap["name"].toString(),
                  "VetEmail": widget.userMap["email"].toString(),
